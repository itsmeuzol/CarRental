...
function FeaturedListings() {
  ...
  const [auctionListings, setAuctionListings] = useState([]); // new
      ...
      try {
        ...
        const saleCars = data
          ...
          .map((car, index) => ({
            ...
            type: `${car.carType} • ${car.transmission || "Unknown"} • ${
              car.fuelType || "Unknown"
            }`,
            price: `₹${parseFloat(
              car.price?.$numberDecimal || 0
            ).toLocaleString()}`,
        ...
        const auctionCars = data
          ...
          .map((car, index) => ({
            id: car.listing_id || index,
            auctionEndTimeFormatted: car.auctionEndTime
              ? new Date(car.auctionEndTime).toLocaleString()
              : "No end time",
        ...
        setAuctionListings(auctionCars); // ✅ Add this
  ...
  return (
    <section className="py-20 bg-gray-200 dark:bg-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl sm:text-4xl font-bold text-center mb-16 text-gray-900 dark:text-white">
          Featured Listings
        </h2>
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          {(selectedOption === "buy"
            ...
            <div
              key={listing.id}
              className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-xl focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-black dark:focus-within:ring-white"
            >
              ...
              <div className="p-6">
                {selectedOption === "auction" &&
                  listing.auctionEndTimeFormatted && (
                    <p className="text-sm text-red-600 dark:text-red-400 mb-2">
                      Ends on: {listing.auctionEndTimeFormatted}
                    </p>
                  )}
        ...
        <div className="text-center mt-16">
          <Link to="CarExplore">
            <button className="px-8 py-3 bg-black text-white rounded-full text-lg font-semibold hover:bg-gray-800 transition duration-300 ease-in-out transform hover:scale-105 inline-flex items-center">
              Explore More
